        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-foreground text-sm">Sydney, AU · London, UK</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5 p-8 rounded-xl bg-card border border-border" style={{ boxShadow: "var(--shadow-card)" }}>
                ...
                <button
                  type="submit"
                  className="w-full inline-flex items-center justify-center gap-2 px-8 py-4 rounded-lg bg-primary text-primary-foreground font-semibold hover:opacity-90 transition-opacity"
                >
