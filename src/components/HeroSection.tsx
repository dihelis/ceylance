      ...
      <div className="relative z-10 container mx-auto px-6 pt-24 pb-20 text-center">
        ...
        >
          <p className="text-primary font-medium text-sm tracking-widest uppercase mb-6">
            Software Consulting — Australia & UK
          </p>
          ...
          <p className="max-w-xl mx-auto text-lg text-muted-foreground mb-10">
            AI solutions, SaaS platforms, web &amp; mobile apps, and workflow automations — 
            engineered for growth across APAC and European markets.
          </p>
