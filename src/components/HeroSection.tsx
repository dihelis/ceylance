  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 pt-24 pb-20 text-center">
        ...
        ease: "easeOut"
          ...
          <p className="max-w-xl mx-auto text-lg text-muted-foreground mb-10">AI solutions, SaaS platforms, web & mobile apps, and workflow automations — engineered for growth across APAC and European EMEA markets.</p>
